...
- Commands: `/quiz`, `/random`, `/go`, `/new`, `/unseen`, `/topic`, `/search`, `/bank`, `/streak`, `/last`, `/repeat`, `/today`, `/remain`, `/count`, `/mastered`, `/weaktopic`, `/question`, `/id`, `/next`, `/practice`, `/easy`, `/medium`, `/hard`, `/challenge`, `/review`, `/wrong`, `/mistakes`, `/export`, `/current`, `/show`, `/map`, `/topics`, `/hint`, `/explain`, `/achievements`, `/skip`, `/giveup`, `/stats`, `/score`, `/progress`, `/status`, `/about`, `/reset`, `/help`
- `/count` quick summary; `/weaktopic` suggests what to practice; `/unseen`, `/repeat`, `/show`, `/id` are aliases
